 ...
 * Follows the same re-entry guard pattern as {@link WebhookDispatchScheduler}:
...
public class WebhookDispatchScheduler {
    ...
    private final IWebhookDispatchUseCase webhookDispatchUseCase;
    ...
    Mono<Void> executeWebhookWorkerFlow() {
        ...
        return Mono.defer(() -> {
            ...
            return webhookDispatchUseCase.pollAndProcess(workerId, batchSize)
