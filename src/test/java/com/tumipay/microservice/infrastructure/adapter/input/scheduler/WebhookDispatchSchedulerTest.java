 ...
 * <p>
 * Unit tests for {@link WebhookDispatchScheduler}.
 * <p>
...
class WebhookDispatchSchedulerTest {
    ...
    @Mock
    private IWebhookDispatchUseCase webhookWorkerUseCase;
    ...
    @BeforeEach
    void setUp() {
        scheduler = new WebhookDispatchScheduler(webhookWorkerUseCase, webhookDispatcherProperties);
    }
